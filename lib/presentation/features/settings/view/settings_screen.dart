...
class _SettingsViewState extends State<SettingsView> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<SettingsBloc, SettingsState>(
      ...
      child: Scaffold( // Add Scaffold for AppBar and body structure
          appBar: AppBar(
          ...
          body: Padding(
            ...
            child: BlocBuilder<SettingsBloc, SettingsState>(
              builder: (context, state) {
                bool isLoading = state.status == SettingsStatus.loading || state.status == SettingsStatus.saving;
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: (state.status == SettingsStatus.editing && !isInteractionDisabled)
                          ? () => context.read<SettingsBloc>().add(SaveSettingsClicked())
                          : null,
                      child: isLoading
                          ? const SizedBox(
                              width: 20,
